...
export const LANGUAGES: {
  ...
  { code: "en", label: "English", native: "English", flag: "🇬🇧", coin: "Peach Blossom Coins" },
  { code: "zh", label: "Traditional Chinese", native: "繁體中文", flag: "🇹🇼", coin: "桃源幣" },
  { code: "zh-CN", label: "Simplified Chinese", native: "简体中文", flag: "🇨🇳", coin: "桃源币" },
  { code: "ja", label: "Japanese", native: "日本語", flag: "🇯🇵", coin: "桃源コイン" },
  { code: "ko", label: "Korean", native: "한국어", flag: "🇰🇷", coin: "복숭아꽃 코인" },
  { code: "es", label: "Spanish", native: "Español", flag: "🇪🇸", coin: "Monedas Flor de Durazno" },
];
...
export const DICT = {
  ...
  // Nav
  "nav.hub": { en: "Hub", zh: "中心", "zh-CN": "中心", ja: "ハブ", ko: "허브", es: "Hub" },
  "nav.eco": { en: "Eco", zh: "生態", "zh-CN": "生态", ja: "エコ", ko: "에코", es: "Eco" },
  "nav.path": { en: "Path", zh: "工藝", "zh-CN": "工艺", ja: "パス", ko: "장인", es: "Ruta" },
  "nav.coin": { en: "Coin", zh: "錢包", "zh-CN": "钱包", ja: "コイン", ko: "코인", es: "Cartera" },
  "nav.report": {
    en: "Report",
    zh: "回報",
    "zh-CN": "回报",
  ...
  "eco.final": { en: "Final", zh: "終極", "zh-CN": "终极", ja: "最終", ko: "최종", es: "Final" },
  "eco.listening.tag": {
    en: "Silent Listening",
    zh: "靜謐聆聽",
    "zh-CN": "静谧聆听",
  ...
  "culture.away": { en: "away", zh: "外", "zh-CN": "外", ja: "先", ko: "거리", es: "de distancia" },
  "culture.oral": {
  ...
  "fahy.label": { en: "Fahy", zh: "花仔", "zh-CN": "花仔", ja: "Fahy", ko: "Fahy", es: "Fahy" },
} as const;
...
export function LanguageProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    try {
      ...
      if (nav.startsWith("zh-CN") || nav.startsWith("zh-Hans")) setLangState("zh-CN");
